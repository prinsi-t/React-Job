...
const JobListing = ({ job }) => {
  ...
  return (
    <div className="modern-card hover-lift animate-fadeInUp bg-gradient-to-br from-slate-900/90 via-blue-950/90 to-slate-900/90 backdrop-blur-sm h-full flex flex-col">
